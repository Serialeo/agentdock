...
func TestSkillEnvironmentActionsDoNotReturnValuesAndExecCommandUsesPriority(t *testing.T) {
	...
	defer runtime.Close()
	projectCtx := projectContextForTest(t, runtime, runtime.Config().AgentDockDefaultDir, fullProjectPermissionsForTest())

	const secret = "skill-secret-value"
	setResult, err := runtime.Call(projectCtx, "skill_package", map[string]any{
		"action": "env_set",
		"skill":  "demo-skill",
		"key":    "DEMO_SECRET",
		"value":  secret,
	...
	listResult, err := runtime.Call(projectCtx, "skill_package", map[string]any{
		"action": "env_list",
		"skill":  "demo-skill",
	})
	if err != nil {
	...
	loaded, err := runtime.Call(projectCtx, "exec_command", map[string]any{
		"cmd":            loadedCommand,
	...
	overridden, err := runtime.Call(projectCtx, "exec_command", map[string]any{
		"cmd":            overrideCommand,
		"skill_env":      "demo-skill",
	...
	unsetResult, err := runtime.Call(projectCtx, "skill_package", map[string]any{
		"action": "env_unset",
		"skill":  "demo-skill",
		"key":    "DEMO_SECRET",
	})
...
func TestMCPEnvironmentActionsDoNotReturnValues(t *testing.T) {
	...
	_, err := runtime.Call(projectCtx, "mcp_manage", map[string]any{
		"action":      "add",
		"name":        "demo-mcp",
	...
	setResult, err := runtime.Call(projectCtx, "mcp_manage", map[string]any{
		"action": "env_set",
		"name":   " demo-mcp ",
		"key":    "MCP_SECRET",
		"value":  secret,
	...
	listResult, err := runtime.Call(projectCtx, "mcp_manage", map[string]any{
		"action": "env_list",
		"name":   " demo-mcp ",
	})
	if err != nil {
	...
	unsetResult, err := runtime.Call(projectCtx, "mcp_manage", map[string]any{
		"action": "env_unset",
		"name":   " demo-mcp ",
		"key":    "MCP_SECRET",
	})
...
func TestExecCommandSkillBindsActiveRootAndEnvironment(t *testing.T) {
	...
	_, err := runtime.Call(projectCtx, "skill_package", map[string]any{
		"action": "env_set",
		"skill":  "demo-skill",
		"key":    "DEMO_SECRET",
	...
	invocation, err := runtime.Call(projectCtx, "exec_command", map[string]any{
...
func TestExecCommandSkillRejectsConflictingEnvironmentBinding(t *testing.T) {
	...
	_, err := runtime.Call(projectCtx, "exec_command", map[string]any{
