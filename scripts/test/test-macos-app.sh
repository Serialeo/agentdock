...
COMPUTER_APP="$APP/Contents/Helpers/AgentDockComputer.app"
COMPUTER_HELPER="$COMPUTER_APP/Contents/MacOS/agentdock-computer"
test -x "$COMPUTER_HELPER"
test "$(plutil -extract CFBundleIdentifier raw -o - "$COMPUTER_APP/Contents/Info.plist")" = "com.uvwt.agentdock.computer"
codesign --verify --strict "$COMPUTER_APP"
